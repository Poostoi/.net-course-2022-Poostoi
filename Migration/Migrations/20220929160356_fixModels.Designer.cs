...
namespace Migration.Migrations
{
    ...
    [Migration("20220929160356_fixModels")]
            ...
            modelBuilder.Entity("ModelsDb.AccountDb", b =>
                {
                    ...
                    b.HasOne("ModelsDb.CurrencyDb", "CurrencyDb")
                        .WithMany("AccountDbs")
                        .HasForeignKey("CurrencyDbId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ClientDb");

                    b.Navigation("CurrencyDb");
                });
